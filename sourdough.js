...
/* cssQuery, version 2.0.2 (2005-08-19) Copyright: 2004-2005, Dean Edwards (http://dean.edwards.name/) License: http://creativecommons.org/licenses/LGPL/2.1/ */
...
// TODO ? createEvent or just normalize it??
$.event = function(){
...
trigger: function(_type){
	...
	// TODO convert _type to something appropriate using $.event.eventType
	// like UIEvent, 
	// TODO handle arguments for initEvent
	//var _create = document.createEvent;//,
	var type = $.event.eventType[_type] || 'UIEvent';
	this.each(function(){
...
// setup synonyms
$.prototype.listen = $.prototype.bind;
